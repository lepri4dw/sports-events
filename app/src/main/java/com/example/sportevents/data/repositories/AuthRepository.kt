...
class AuthRepository : BaseRepository() {
    ...
    suspend fun registerUser(email: String, displayName: String, password: String): Resource<AuthResponse> {
    ...
    suspend fun refreshToken(refreshToken: String): Resource<TokenRefreshResponse> {
    ...
    suspend fun updateCurrentUser(updates: Map<String, Any>): Resource<User> {
